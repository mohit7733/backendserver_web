...
const emailverification = (recipientName = "User", otp = "") => ({
    html: `
    <!DOCTYPE html>
    <html>
    <head>
        <meta charset="UTF-8">
        <title>Email Verification - Web Guru Awards</title>
        <style>
            body {
                font-family: Arial, sans-serif;
                background: #f7f7f7;
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <div class="otp-box">${otp}</div>
                <p>
                    This OTP is valid for a limited time and can only be used once. If you did not request a email verification, please ignore this email.
                </p>
                <p>
                    If you need further assistance, feel free to contact us at 
                    <a href="mailto:info@webguruawards.com" style="color:#e0621f;text-decoration:underline;">info@webguruawards.com</a>.
...
module.exports = { emailTemplateapproved, websiteadditionalinfo, guruofday, emailTemplatesubmited, forgetpassword, emailverification };
